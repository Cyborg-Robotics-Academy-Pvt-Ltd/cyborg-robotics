    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-gray-800">Student Renewal Form</h1>
          <p className="mt-2 text-gray-600">Complete your registration in just a few steps</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-800 to-red-600 px-6 py-4">
            <div className="flex items-center justify-between px-4">
              ...
              <span className="text-white font-medium">{step}/{totalSteps}</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8">
            ...
            {step === 2 && (
              <div className="space-y-6 transform transition-all duration-300 opacity-100">
                <h2 className="text-xl font-semibold text-gray-800 border-b pb-2">Schedule & Location</h2>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="flex items-center text-gray-700 text-sm font-semibold mb-2" htmlFor="preferredDay">
                  ...
                  <div>
                    <label className="flex items-center text-gray-700 text-sm font-semibold mb-2" htmlFor="preferredTime">
                      <span className="mr-2">⏰</span>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md mx-4 text-center transform transition-all duration-300 scale-100 opacity-100">
            ...
            <p className="text-gray-600 mb-6">Your renewal form has been submitted successfully. We will contact you shortly to confirm your registration.</p>
            <button
...
const FormField: React.FC<FormFieldProps> = ({ 
  ...
  <div>
    <label className="flex items-center text-gray-700 text-sm font-semibold mb-2" htmlFor={id}>
