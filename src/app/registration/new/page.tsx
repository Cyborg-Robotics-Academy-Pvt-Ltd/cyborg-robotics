...
const RegisterPage: React.FC = () => {
  ...
  }, [sameAsCurrentAddress, formData.currentAddress, formData.permanentAddress]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 py-6 md:py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto mt-10">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all">
          <div className="bg-gradient-to-r from-red-800 via-red-700 to-red-600 px-6 py-8">
          ...
          <form onSubmit={handleSubmit} className="p-3 md:p-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-5 md:p-8 border border-gray-200 shadow-inner">
              <div className="grid grid-cols-1 gap-5 md:gap-8">
                ...
                <div className="flex items-center px-1 py-2">
                  ...
                  />
                  <label htmlFor="sameAddress" className="ml-3 text-sm font-medium text-gray-700 cursor-pointer">
            ...
            <div className="bg-gray-50 rounded-2xl p-5 md:p-8 border border-gray-200 shadow-inner">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700 space-y-3">
                <li className="pl-1">Cover up class will not be provided for uninformed leaves. One day prior intimation is mandatory.</li>
                <li className="pl-1">Taxes and other applicable charges, if any, will be charged extra.</li>
                <li className="pl-1">Fees and other charges paid are not refundable.</li>
              ...
              <div className="flex items-center mt-6 bg-white p-4 rounded-xl border border-gray-200">
                <input
                  ...
                  required
                />
                <label htmlFor="termsAccepted" className="ml-3 text-sm font-medium text-gray-700 cursor-pointer">
            ...
            <div className="flex items-center justify-center mt-10">
              <button
                ...
                } text-white font-bold py-4 px-12 rounded-xl shadow-lg focus:outline-none focus:ring-4 focus:ring-red-400 focus:ring-opacity-50 transform transition-all ${
                  !isSubmitting && termsAccepted ? 'hover:scale-105' : ''
                }`}
                type="submit"
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-gray-500 text-xs mt-2">
            &copy; {new Date().getFullYear()} Cyborg Robotics Academy Pvt Ltd. All rights reserved.
          </p>
        </div>
      </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md mx-4 text-center transform transition-all duration-300 scale-100 opacity-100">
            ...
            <p className="text-gray-600 mb-6">Your registration form has been submitted successfully. We&#39;ll contact you shortly to confirm your registration.</p>
            <button
