...
const TermsPage = () => {
  return (
    <div className="bg-gray-50 min-h-screen md:mt-14">
          ...
          <div className="p-6 md:p-10 space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                charge for using the Site. &quot;Products&quot; means the goods
                and services displayed on the Site and offered for sale/use.
                &quot;Site&quot; means www.cyborgrobotics.in owned and operated
                by Cyborg Robotics Academy Private Limited.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                You are responsible for all activities under your account. This
                includes:
              </p>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                provided &quot;AS IS&quot; without warranties and should not be
                relied upon for making critical decisions.
              </p>
            </section>
