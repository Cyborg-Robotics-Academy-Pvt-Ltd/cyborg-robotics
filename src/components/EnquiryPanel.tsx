...
const EnquiryPanel = () => {
  return (
    <div className="mx-auto w-[90%] bg-red-700 text-white p-3 md:p-5 rounded-lg sticky top-0 z-10">
    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:flex lg:flex-wrap items-start lg:items-center gap-3 md:gap-6 lg:gap-8 w-full lg:w-auto">
        <div className="min-w-[120px]">
          <div className="text-xs md:text-sm uppercase opacity-80">Teacher:</div>
          <div className="text-sm md:text-base font-medium">Certified Trainer</div>
        </div>
        ...
        <div className="min-w-[120px]">
          <div className="text-xs md:text-sm uppercase opacity-80">Duration:</div>
        ...
        <div className="min-w-[120px]">
          ...
          <div className="text-sm md:text-base font-medium">Call Us for details</div>
        </div>
      </div>
