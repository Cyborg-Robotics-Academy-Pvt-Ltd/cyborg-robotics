    ...
    >
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-between flex-col py-2">
          ...
          >
            <motion.p className={`text-lg mt-2 text-gray-700 text-mono`}>
          ...
          <div className=" pt-12 md:pt-6">
            <Link href="/about" className=" ">
              <button className="relative group border-none bg-transparent p-0 outline-none cursor-pointer font-mono font-light uppercase text-base">
                <span className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-25 rounded-lg transform translate-y-0.5 transition duration-[400ms] ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:translate-y-1 group-hover:duration-[250ms] group-active:translate-y-px"></span>
                ...
                <div className="relative flex font-mono items-center justify-between py-3 px-6 text-lg text-white rounded-lg transform -translate-y-1 bg-red-700  gap-3 transition duration-[400ms] ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:-translate-y-1.5 group-hover:duration-[250ms] group-active:-translate-y-0.5 brightness-100 group-hover:brightness-110">
