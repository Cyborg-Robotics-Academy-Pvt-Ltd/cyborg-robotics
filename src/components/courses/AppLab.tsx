...
import { Code, Layout, Play, Monitor } from "lucide-react";
...
const AppLab = () => {
  ...
  const keyFeatures = [
    {
      ...
      description:
        "Learn JavaScript through both visual blocks and text-based coding",
      icon: <Code className="text-red-700" size={24} />,
    },
    {
      title: "Event-Driven Programming",
      description: "Create apps that respond to user inputs and interactions",
      icon: <Play className="text-red-700" size={24} />,
    },
    {
      title: "UI Design",
      description:
        "Design interactive interfaces with buttons, text fields and more",
      icon: <Layout className="text-red-700" size={24} />,
    },
    {
      title: "Mobile & Web Apps",
      description: "Build applications that work across multiple platforms",
      icon: <Monitor className="text-red-700" size={24} />,
    },
  ];
  ...
  const handleDownloadSyllabus = () => {
    ...
    link.href = "/assets/pdf/App Lab.pdf"; // Update this path to your actual syllabus file
    link.download = "App Lab.pdf"; // This will be the name of the downloaded file
    ...
    <div className="mx-auto max-w-7xl md:mt-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-6">
              Create interactive applications with JavaScript using block-based
          ...
          <div className="space-y-8 relative">
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Get familiar with the App Lab interface and learn the basics
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Progress from block-based to text-based JavaScript coding with
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Develop and deploy fully functional mobile and web
                  applications using all skills learned.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-16 mx-4 lg:mx-8">
        ...
        >
          ...
          <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
            Our structured curriculum covers every aspect of App Lab development
      ...
      >
        ...
        <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
          Join our comprehensive App Lab course and learn to build interactive
