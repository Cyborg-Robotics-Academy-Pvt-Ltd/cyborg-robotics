...
import { Box, Layers, PenTool, FileCode, Star } from "lucide-react";
...
const Printing3d = () => {
  ...
  const keyFeatures = [
    {
      title: "3D Modeling",
      description: "Learn to create detailed 3D models for printing",
      icon: <Box className="text-red-700" size={24} />,
    },
    {
      title: "Design Techniques",
      description: "Master design principles for functional 3D printed objects",
      icon: <PenTool className="text-red-700" size={24} />,
    },
    {
      title: "Printing Technology",
      description: "Understand different printing methods and materials",
      icon: <Layers className="text-red-700" size={24} />,
    },
    {
      title: "Custom Projects",
      description: "Create your own unique 3D printed objects and prototypes",
      icon: <FileCode className="text-red-700" size={24} />,
    },
  ];
  ...
  const handleDownloadSyllabus = () => {
    ...
    link.href = "/assets/pdf/3D PRINTING.pdf"; // Update this path to your actual syllabus file
    link.download = "3D PRINTING.pdf"; // This will be the name of the downloaded file
    ...
    <div className="mx-auto max-w-7xl md:mt-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-6">
              Learn to create three-dimensional objects from digital designs and
              master the technology revolutionizing industries
            </p>
      ...
      >
        ...
        <p className="text-gray-700 lg:text-lg">
          ...
          from digital files. When you print a page on a traditional printer,
          there are only two dimensions: the front and back of the page.
          Three-dimensional printing adds a third dimension: volume. 3D printing
      ...
      {/* Learning Path - Updated to match Bambino Coding style */}
      <motion.div
          ...
          <div className="space-y-8 relative">
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Learn to create 3D models using specialized software and
                  understand design constraints for printing.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Master the process of converting 3D models to printer
                  instructions and setting up optimal print parameters.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Operate 3D printers and learn post-processing techniques to
                  refine your printed objects.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-start">
              ...
              <div className="flex-grow bg-white p-5 rounded-xl shadow-sm md:ml-4">
                ...
                <p className="text-gray-700">
                  Explore advanced applications and industry-specific uses of 3D
                  printing technology.
                </p>
              </div>
            </div>
      ...
      >
        <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">
          Benefits of 3D Printing Skills
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-5 rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 text-sm">
              Unleash creativity by designing and bringing your unique ideas to
              life
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 text-sm">
              Develop valuable technical abilities in CAD design and
              manufacturing
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 text-sm">
              Enhance spatial reasoning and practical problem-solving abilities
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 text-sm">
              Create prototypes and products for potential business ventures
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm">
            ...
            <p className="text-gray-700 text-sm">
              Master technology that&apos;s revolutionizing manufacturing and
              production
            </p>
          </div>
        </div>
      ...
      <div className="mt-16 mx-4 lg:mx-8">
        ...
        >
          ...
          <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
            Our structured curriculum covers every aspect of 3D printing from
            modeling to final production
          </p>
        </motion.div>
      ...
      >
        <h2 className="text-2xl lg:text-3xl font-bold text-red-800 mb-4">
          Ready to Create Amazing 3D Objects?
        </h2>
        <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
          Join our comprehensive 3D Printing course and learn to bring your
